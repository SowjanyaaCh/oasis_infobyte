...
public class Guess_the_Number_Game {
	...
	public static void guessing_the_Number_Game()
	{
		...
		System.out.println("Enter the number of trails that can be done");
		...
		System.out.println("Guess the number"+ " within "+no_of_trails+" trials.");
		...
		for (x = 0; x < no_of_trails; x++) {
			...
			else if (number > guess && x != no_of_trails - 1) {
		...
		if (x == no_of_trails) {
			...
			System.out.println("You have exhausted" +no_of_trails+" trials.");
